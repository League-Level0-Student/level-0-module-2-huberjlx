...
public class StringsCannotAdd {
	...
	public static void main(String[] args) {
		...
		String fourAsString= JOptionPane.showInputDialog(null, "Put in 4");
				
			// 3) Ask the user to enter number 6 and hold it in the variable sixAsString 
			String sixAsString =JOptionPane.showInputDialog(null,"put in 6");
			...
			String fiveAsString=JOptionPane.showInputDialog("Put in 5");
